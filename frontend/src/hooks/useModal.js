...
import TrainingSuggestionModal from '../modals/TrainingSuggestionModal';
            ...
            {(context) => {
                ...
                return (
                    <div>
                        ...
                        {context.currentlyShowingModal === MODAL_TYPE.TRAINING_SUGGESTION && (
                            <TrainingSuggestionModal {...allProps} />
                        )}
                    </div>
                );
            }}
